...
# We'll use these but filter for Spring
...
def plot_nwea_dual_subject_winter_spring_dashboard(
    ...
    out_name = f"{scope.replace(' ', '_')}_NWEA_section0_1_dual_subject_winter_spring_snapshot.png"
...
def main(nwea_data=None):
    """
    Main function to generate NWEA Spring charts
    ...
    parser = argparse.ArgumentParser(description='Generate NWEA Spring charts')
    parser.add_argument('--partner', required=True, help='Partner name')
    parser.add_argument('--data-dir', required=False, help='Data directory path')
    parser.add_argument('--output-dir', required=True, help='Output directory path')
    parser.add_argument('--dev-mode', default='false', help='Development mode')
    ...
    print(f"\n✅ Generated {len(unique_chart_paths)} unique NWEA Spring charts")
