"""
STAR chart filtering and validation utilities
"""
...
def apply_chart_filters(df, filters):
    ...
    if filters.get("grades") is not None and len(filters["grades"]) > 0:
        ...
        # STAR uses studentgrade column
        grade_col = "studentgrade" if "studentgrade" in d.columns else "grade"
    ...
    # Filter by years (STAR uses academicyear)
...
def should_generate_subject(subject, filters):
    ...
    # STAR uses "Reading" and "Mathematics" (or "Math")
    subject_map = {
